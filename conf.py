...
CONTENT_FOOTER = '<a href="/impressum">Impressum/Kontakt - Imprint/Contact</a> - Contents &copy; 2019         <a href="mailto:{email}">{author}</a> - Powered by         <a href="http://getnikola.com" rel="nofollow">Nikola</a>         {license}<br><br>'
